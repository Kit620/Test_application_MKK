"""Initial tables: buildings, activities, organizations, phones, organization_activities.
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.CheckConstraint("level >= 1 AND level <= 3", name="activities_level_1_to_3"),
    )
    ...
    op.create_index(
        op.f("ix_organization_phones_id"),
        "organization_phones",
        ["id"],
        unique=False,
    )
